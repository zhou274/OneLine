...
class EditorUpdate
{
    ...
    static void Update()
    {
        ...
        string from = "Assets/OneLine/Plugins/Android/GoogleMobileAdsPlugin.androidlib";
        ...
        if (Directory.Exists(from) && !Directory.Exists(to))
        {
            ...
            AssetDatabase.MoveAsset("Assets/OneLine/Plugins/Android/googlemobileads-unity.aar", "Assets/Plugins/Android/googlemobileads-unity.aar");
        }

        from = "Assets/OneLine/Resources/BillingMode.json";
        ...
        if (File.Exists(from))
        {
            ...
            if (Directory.GetFiles("Assets/OneLine/Resources").Length == 0)
            {
                AssetDatabase.DeleteAsset("Assets/OneLine/Resources");
            }
        }
